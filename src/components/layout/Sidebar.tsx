...
export const Sidebar: React.FC<SidebarProps> = ({
          ...
          <NavLink
            ...
            className={`group relative flex items-center ${
              ...
              isActive
                ...
                : 'text-[#9CA3AF] hover:text-[#F3F4F6] hover:bg-[#151A21] border border-transparent'
            }`}
              ...
              <Icon
                className={`w-5 h-5 shrink-0 transition-all duration-200 ${
                  isActive
                    ...
                    : 'text-[#6B7280] group-hover:text-[#F3F4F6] group-hover:scale-105'
                }`}
              />
              ...
              <span
                className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                  isActive
                    ...
                    : 'bg-[#222934] text-[#9CA3AF] group-hover:bg-[#2C3544]'
                }`}
              >
                {item.badge}
              </span>
  ...
  return (
    <>
      {/* ------------------------------------------------------------- */}
      {/* 1. Desktop & Tablet Permanent/Collapsible Sidebar             */}
      {/* ------------------------------------------------------------- */}
      <aside
        className={`hidden md:flex flex-col bg-[#0B0F14] border-r border-[#222934] h-[calc(100vh-4rem)] sticky top-16 transition-all duration-300 z-20 select-none ${
          isTabletCollapsed ? 'w-20' : 'w-64'
        }`}
      >
        {/* Sidebar Header / Collapse Toggle Button */}
        <div
          className={`px-4 py-3 border-b border-[#222934]/60 flex items-center ${
        ...
        >
          ...
          <button
            ...
            className="p-1.5 text-[#9CA3AF] hover:text-[#F3F4F6] hover:bg-[#151A21] rounded-lg border border-[#222934] transition-colors"
        ...
        {/* Sidebar Footer / Mic Promo Widget */}
        <div className="p-3 border-t border-[#222934]">
          {!isTabletCollapsed ? (
            <div className="bg-gradient-to-b from-[#151A21] to-[#0D1117] p-3.5 rounded-2xl border border-[#222934] relative overflow-hidden group">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-bold text-[#F3F4F6]">Voice Engine</span>
              </div>
              <p className="text-[11px] text-[#9CA3AF] leading-tight mb-2.5">
      ...
      {/* ------------------------------------------------------------- */}
      {/* 2. Mobile Drawer Navigation (Slide-over + Backdrop Overlay)   */}
      {/* ------------------------------------------------------------- */}
      <AnimatePresence>
        {isMobileOpen && (
          <>
            ...
            <motion.div
              ...
              onClick={onCloseMobile}
              className="fixed inset-0 bg-[#0B0F14]/80 backdrop-blur-md z-40 md:hidden"
            />
            ...
            <motion.aside
              ...
              className="fixed top-0 left-0 bottom-0 w-72 bg-[#0B0F14] border-r border-[#222934] z-50 flex flex-col md:hidden shadow-2xl"
            >
              {/* Drawer Header */}
              <div className="h-16 px-4 border-b border-[#222934] flex items-center justify-between">
                ...
                <button
                  onClick={onCloseMobile}
                  className="p-2 text-[#9CA3AF] hover:text-[#F3F4F6] hover:bg-[#151A21] rounded-xl transition-colors"
              ...
              <div className="p-4 border-t border-[#222934] bg-[#151A21]/50">
